	...
	<div class='container'>
		<div class="homepage-container">
			<div class='row outer-bottom-sm'>
				...
				<div class='col-md-9'>
					<?php require UC_ROOT.'/parts/section/category-page-slider2.php' ?>
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="grid-container">
								<div class="category-product  inner-top-vs">
									<div class="row">									
										<?php 											
											require UC_ROOT.'/parts/section/category2-grid.php'; 
										?>
									</div><!-- /.row -->
							...
							<div class="tab-pane"  id="list-container">
								<div class="category-product  inner-top-vs">
									...
									<?php 
										require UC_ROOT.'/parts/section/category2-list.php'; 
									?>
